  ...
  <table class="table table-striped mt-3">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= $buku['penerbit'];?></td>
        <td><?= $buku['tahun'];?></td>
        <td><img src="<?= base_url($buku['thumbnail_url'])?>" alt="<?= $buku['judul']?>" class="img-thumbnail" style="width: 150px; height: auto">
      </td>
        <td>
          <a href="<?= base_url('admin/databuku/' . $buku['id'] . '/edit')?>" class="btn btn-success btn-sm bi bi-pencil-square"></i> Edit</a>
