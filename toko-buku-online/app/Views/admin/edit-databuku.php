...
<div class="mb-3">
    <form action="<?= base_url('admin/databuku/' . $buku['id'] . '/update') ?>" method="POST" enctype="multipart/form-data"
        id="formTambah">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="file" accept="image/*" name="thumbnail_url" id="thumbnail_url"
                class="form-control">
                <img src="<?=base_url($buku['thumbnail_url'])?>" alt="" class="img-thumbnail" style="widht: 150px; height: auto;">
        </div>
        <div class="b-3">
