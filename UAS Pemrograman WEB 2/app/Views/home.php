...
<div class="container">
    <div class="row bg-primary-subtle">
        <div class="col-6 p-5">
            <h1> Selamat Datang Di Toko Skincare </h1>
        ...
        <div class="col-6 p-5">
            ...
            <form action="<?= base_url('search') ?>" method="GET">
                <div class="mb-3">
                    <input type="text" name="Slincare" id="Skincare" class="form-control" placeholder="Pilih Skincare">
                </div>
                <div class="mb-3">
        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Niacinemaid Clay Stick</h5>
